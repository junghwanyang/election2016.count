insert overwrite local directory 'keyword.count/sandersOwn'
...
where
    ...
    --and
    (
        lower(user.screen_name) like 'berniesanders'
        or
        lower(user.screen_name) like 'sensanders'
        or
        (
            (
...
-- This script tweets from '@BernieSanders' or '@SenSanders' and retweets of Bernie Sanders's tweet (RT @BernieSanders, RT @SenSanders)
