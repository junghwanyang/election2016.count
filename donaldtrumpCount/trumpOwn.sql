insert overwrite local directory 'keyword.count/trumpOwn'
...
where
    ...
    --and
    (
        lower(user.screen_name) like 'realdonaldtrump'
        or
        (
...
-- This script tweets from '@realdonaldtrump' and retweets of Hillary Clinton's tweet (RT @realdonaldtrump)
