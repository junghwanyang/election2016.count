insert overwrite local directory 'keyword.count/clintonOwn'
...
where
    ...
    --and
    (
        lower(user.screen_name) like 'hillaryclinton'
        or
        (
...
-- This script tweets from '@HillaryClinton' and retweets of Hillary Clinton's tweet (RT @HillaryClinton)
